...
**MySQLTuner** prend en charge environ 400 indicateurs et KPI (y compris le score de santé pondéré) pour MySQL/MariaDB/Percona Server dans cette dernière version.
