...
- **Documentation Sync & Refresh**: Fully updated and synchronized `README.md` (including French, Italian, and Russian translations), `INTERNALS.md`, and `USAGE.md` to cover all modern features and options of MySQLTuner v2.8.43.
