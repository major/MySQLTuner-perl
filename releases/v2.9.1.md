...
- feat(cli): implement agent-json flag returning structured actionable schema
- feat(cli): resolve remote memory, socket override, and temptable sizing issues
- feat(container): implement dockerized auditing daemon and zero-dependency MCP server
...
- feat(main): implement advanced log parser and lock monitoring
