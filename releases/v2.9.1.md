...
- feat(cli): implement agent-json flag returning structured actionable schema (#955)
- feat(cli): resolve remote memory, socket override, and temptable sizing issues
- feat(container): implement dockerized auditing daemon and zero-dependency MCP server (#954)
...
- feat(main): implement advanced log parser and lock monitoring (#953)
