...
- feat(engine): pure calculation subroutines, memory decomposition, and CLI contract hardening (#1048)
- feat(engine): add statistical statement analysis CSV export in dumpdir
- fix(ci): allow 'release' scope in commit and changelog compliance auditor (#1047)
- fix(ci): refine audit_logs warning filter to prevent false positives on deprecation advice
- fix(engine): fix sys views query escaping and dumpdir initialization in select_csv_file
- fix(engine): skip legacy disabled status and variables views in information_schema dump
- fix(triage): address CodeRabbit review recommendations on PR #989
...
- test(ci): guard END cleanup blocks against uninitialized variables on skipped tests (#1046)
- test(engine): add adversarial fuzzing, mutation testing, and pure metrics unit tests (#1048)
- test(engine): add unit tests for dumpdir statistical analysis, query escaping, and directory creation
- test(engine): add unit tests for information_schema view filtering in dumpdir
...
- docs(mcp): update AI agent skills, architecture diagrams, and integration guide (#1048)
```
...
- fix(engine): skip disabled status and variables views in information_schema dump (9493f94)
- docs: regenerate release notes (5897781)
- fix(engine): resolve sys views query escaping and dumpdir initialization in select_csv_file (8b1d5e9)
- docs: regenerate release notes (6595a0a)
- fix(triage): address CodeRabbit review recommendations on PR #989 (ad57c00)
- docs: regenerate release notes (7e42570)
- feat(engine): add statistical statement analysis CSV export in dumpdir (660e89b)
- docs: regenerate release notes (fd0aca5)
- feat(engine): pure calculation metrics and CLI contract hardening (#1048) (5be5ca0)
- docs: regenerate release notes (ab2c97b)
- fix(ci): allow 'release' scope in commit and changelog compliance auditor (#1047) (65cc12b)
- docs: regenerate release notes (1babc23)
- test(ci): guard END cleanup blocks against uninitialized variables on skipped tests (#1046) (52726bf)
- docs: regenerate release notes (f8a73c4)
